...
웹 및 리버싱 취약점 분석 역량 강화를 위해 익스플로잇부터 대응 방안까지의 과정을 기록
...
* [SelfRead](./dreamhack/reversing/bronze/bronze-1/selfread/selfread.md) - **자기 참조(/proc/self/exe) 연산 로직 분석 및 동적 디버깅 기반 평문 비교 메모리 탈취**
...
* [Insecure Logging](./vulnerable-apps/allsafe/insecure-logging/insecure-logging.md) - **디컴파일 및 logcat 모니터링을 통한 시크릿 입력값 평문 로그 노출 확인**
